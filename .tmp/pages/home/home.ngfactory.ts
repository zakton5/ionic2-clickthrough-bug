...
class _View_HomePage_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._HomePage_0_4 = new import3.HomePage(this.parentInjector.get(import8.NavController),this.parentInjector.get(import9.ModalController));
...
class _View_HomePage0 extends import1.AppView<import3.HomePage> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._text_12 = this.renderer.createText(this._el_11,'Ionic 2 - Modal Clickthrough Bug',(null as any));
    ...
    this._Button_14_4 = new import16.Button((null as any),'',this.parentInjector.get(import17.Config),new import18.ElementRef(this._el_14),this.renderer);
    this._appEl_14.initComponent(this._Button_14_4,[],compView_14);
    this._text_15 = this.renderer.createText((null as any),'Show Modal',(null as any));
    compView_14.create(this._Button_14_4,[[].concat([this._text_15])],(null as any));
    this._text_16 = this.renderer.createText((null as any),'\n\n  ',(null as any));
    this._el_17 = this.renderer.createElement((null as any),'textarea',(null as any));
    this.renderer.setElementAttribute(this._el_17,'rows','10');
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import16.Button) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 15)))) { return this._Button_14_4; }
    if (((token === import15.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 18)))) { return this._Content_9_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (import4.checkBinding(throwOnChange,this._expr_4,currVal_4)) {
      this._Button_14_4.block = currVal_4;
      changed = true;
      this._expr_4 = currVal_4;
    }
    if (changed) { this._appEl_14.componentView.markAsCheckOnce(); }
    this.detectContentChildrenChanges(throwOnChange);
    if (!throwOnChange) { if ((this.numberOfChecks === 0)) { this._Button_14_4.ngAfterContentInit(); } }
  ...
  private _handle_click_14_0($event:any):boolean {
    ...
    const pd_0:any = ((<any>this.context.showModal()) !== false);
    return (true && pd_0);
  }
}
export function viewFactory_HomePage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.HomePage> {
  if ((renderType_HomePage === (null as any))) { (renderType_HomePage = viewUtils.createRenderComponentType('/Users/zrkeeton/Projects/BugReportRepos/ionic2-clickthrough-bug/.tmp/pages/home/home.html',0,import10.ViewEncapsulation.None,styles_HomePage,{})); }
