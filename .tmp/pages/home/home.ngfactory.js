...
var _View_HomePage0 = (function (_super) {
    ...
    _View_HomePage0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_12 = this.renderer.createText(this._el_11, 'Ionic 2 - Modal Clickthrough Bug', null);
        ...
        this._Button_14_4 = new import16.Button(null, '', this.parentInjector.get(import17.Config), new import18.ElementRef(this._el_14), this.renderer);
        this._appEl_14.initComponent(this._Button_14_4, [], compView_14);
        this._text_15 = this.renderer.createText(null, 'Show Modal', null);
        compView_14.create(this._Button_14_4, [[].concat([this._text_15])], null);
        this._text_16 = this.renderer.createText(null, '\n\n  ', null);
        this._el_17 = this.renderer.createElement(null, 'textarea', null);
    ...
    _View_HomePage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import16.Button) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 15)))) {
            return this._Button_14_4;
        }
        if (((token === import15.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 18)))) {
    ...
    _View_HomePage0.prototype._handle_click_14_0 = function ($event) {
        ...
        var pd_0 = (this.context.showModal() !== false);
        return (true && pd_0);
    };
...
export function viewFactory_HomePage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_HomePage === null)) {
        (renderType_HomePage = viewUtils.createRenderComponentType('/Users/zrkeeton/Projects/BugReportRepos/ionic2-clickthrough-bug/.tmp/pages/home/home.html', 0, import10.ViewEncapsulation.None, styles_HomePage, {}));
    }
