...
export function viewFactory_MyApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MyApp === null)) {
        (renderType_MyApp = viewUtils.createRenderComponentType('/Users/zrkeeton/Projects/BugReportRepos/ionic2-clickthrough-bug/.tmp/app/app.component.ts class MyApp - inline template', 0, import9.ViewEncapsulation.None, styles_MyApp, {}));
    }
