...
var _View_ToolbarTitle_Host0 = (function (_super) {
    ...
    _View_ToolbarTitle_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._ToolbarTitle_0_4 = new import3.ToolbarTitle(this.parentInjector.get(import8.Config), new import9.ElementRef(this._el_0), this.renderer, this.parentInjector.get(import10.Toolbar, null), this.parentInjector.get(import11.Navbar, null));
    ...
    _View_ToolbarTitle_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.ToolbarTitle) && (0 === requestNodeIndex))) {
...
export var ToolbarTitleNgFactory = new import13.ComponentFactory('ion-title', viewFactory_ToolbarTitle_Host0, import3.ToolbarTitle);
...
export function viewFactory_ToolbarTitle0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ToolbarTitle === null)) {
        (renderType_ToolbarTitle = viewUtils.createRenderComponentType('/Users/zrkeeton/Projects/BugReportRepos/ionic2-clickthrough-bug/node_modules/ionic-angular/components/toolbar/toolbar-title.d.ts class ToolbarTitle - inline template', 1, import12.ViewEncapsulation.None, styles_ToolbarTitle, {}));
    }
